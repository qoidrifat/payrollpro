...
return [
    ...
    */
    ...
    | considered expired. This will override any expiration set on token
    | creation for personal access tokens. If null, tokens never expire.
    |
    */
    ...
    */
    ...
    | request. You may change the middleware referenced below as necessary.
    |
    */
