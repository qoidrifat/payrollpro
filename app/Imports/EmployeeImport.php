...
class EmployeeImport implements SkipsOnFailure, ToModel, WithHeadingRow, WithValidation
{
    ...
    public function model(array $row)
    {
        ...
        return new Employee([
            ...
            'nik' => $row['nik'],
            'nik_hash' => Employee::hashNik($row['nik']),
            'npwp' => $row['npwp'] ?? null,
    ...
    public function rules(): array
    {
        return [
            ...
            'nik_hash' => ['required', Rule::unique('employees', 'nik_hash')->withoutTrashed()],
    ...
    public function customValidationMessages(): array
    {
        return [
            ...
            'nik_hash.unique' => 'NIK sudah terdaftar.',
    ...
    {
        $data['nik_hash'] = Employee::hashNik($data['nik'] ?? null);
